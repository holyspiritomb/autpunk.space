...
export default defineConfig({
  ...
  shortcuts: {
    "btn": "rounded-full shadow-md py-2 px-4 font-bold border-ctp-pink outline-ctp-pink outline-1 shadow-ctp-pink m-[0.5rem] h-[3rem] active:shadow-lg border-1 p-3",
